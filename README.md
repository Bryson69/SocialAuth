...
---
### This is an Authentication App. It's built to allow users to Register and Login. Users can Sign-in Using their usernames as well as their emails. Social authentication features are also added into this application whereby users can Login using **Gmail**, **Facebook** and **Twitter**.
---
## Getting Started
